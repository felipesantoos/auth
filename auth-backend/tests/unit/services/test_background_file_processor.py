...
class TestBackgroundFileProcessing:
    ...
    async def test_process_image_creates_thumbnails(self):
        ...
        service = BackgroundFileProcessor(file_repo_mock, storage_mock, image_processor_mock, Mock())
    ...
    async def test_process_video_creates_preview(self):
        ...
        service = BackgroundFileProcessor(file_repo_mock, storage_mock, Mock(), video_processor_mock)
    ...
    async def test_scan_file_for_viruses(self):
        ...
        service = BackgroundFileProcessor(file_repo_mock, storage_mock, Mock(), video_processor_mock = Mock())
